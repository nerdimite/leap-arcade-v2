...
export async function postPlay(options: PostWordHuntOptions = {}): Promise<PlayResponse> {
...
export async function postSubmit(options: PostWordHuntOptions = {}): Promise<SubmitResponse> {
  const origin = resolveOrigin(options.baseUrl);
