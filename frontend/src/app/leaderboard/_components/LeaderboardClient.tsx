...
export default function LeaderboardClient({
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      <p className="font-pixel text-[9px] uppercase tracking-[2px] text-rapid">▸ Final standings</p>
      <h1 className="mt-3.5 font-pixel text-[15px] leading-[1.5] text-ink">HIGH SCORES</h1>
      <p className="mt-3.5 flex items-center gap-2 text-[14px] text-ink-dim">
        <span
          aria-hidden
          className="size-2 rounded-full bg-four animate-arcade-blink motion-reduce:animate-none"
        />
