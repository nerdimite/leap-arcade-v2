  ...
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center gap-7 px-5 py-10">
      ...
      <section className="w-full max-w-[420px] rounded-[var(--radius)] border-2 border-line bg-panel shadow-[var(--shadow-cabinet)]">
        ...
        <div className="h-2 rounded-t-[2px] bg-wiki" style={{ boxShadow: "0 0 18px var(--wiki)" }} />

        <div className="p-7">
          <h1 className="mt-4 font-pixel text-[13px] leading-[1.5] text-ink">PLAYER LOGIN</h1>
          <p className="mt-3 max-w-[44ch] text-[15px] leading-relaxed text-ink-dim">
            Enter your corp ID and the event code from your facilitator to take the floor.
          </p>
          ...
          <form onSubmit={onSubmit} className="mt-6 flex flex-col gap-5" noValidate>
            <div className="flex flex-col gap-2">
              <label
                htmlFor="corp_id"
                className="text-[10px] font-bold uppercase tracking-[1px] text-ink-faint"
              >
                Corp ID
              </label>
              <input
            ...
            {showInvalidCreds ? (
              <p
                id={errorId}
                role="alert"
                className="flex items-center gap-2.5 rounded-[var(--radius)] border-2 border-cross bg-cross/12 px-3.5 py-3 text-[14px] font-medium text-ink animate-picture-input-shake motion-reduce:animate-none"
              >
                <TriangleAlert aria-hidden className="size-4 shrink-0 text-cross" />
            ...
            <button
              ...
              className={
                ...
                "uppercase tracking-[1.5px] text-bg shadow-[var(--shadow-cabinet-sm)] " +
                ...
                "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wiki " +
