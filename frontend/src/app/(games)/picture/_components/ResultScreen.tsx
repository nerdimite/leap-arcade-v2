...
function statusMeta(status: ResultPuzzle["status"]): {
  label: string
  className: string
} {
  switch (status) {
    ...
    case "skipped":
      return {
        label: "Skipped",
        className: "border-rapid/40 bg-rapid/12 text-rapid",
      }
    case "wrong":
      return {
        label: "Wrong",
  ...
  return (
    <div className="mx-auto flex max-w-lg flex-col gap-6 p-6 pb-10">
      <div className="overflow-hidden rounded-[var(--radius)] border-2 border-line bg-panel shadow-[var(--shadow-cabinet)]">
        ...
        />
        <div className="p-6">
          <p className="font-pixel text-[9px] tracking-[2px] text-[var(--accent,var(--pic))] uppercase">
            ▸ You&apos;re done
          </p>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <div className="rounded-[var(--radius)] border-2 border-line bg-bg-2 p-4">
              ...
              <p className="mt-1.5 font-pixel text-[16px] text-ink tabular-nums">
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {puzzle.score_earned > 0 ? (
                    <p className="mt-1.5 text-[12px] text-ink-dim tabular-nums">
