...
export function RapidFireErrorState(props: {
  message?: string
  onBackToLobby: () => void
}) {
  return (
    <div className="rounded-[var(--radius)] border-2 border-line bg-panel p-6 shadow-[var(--shadow-cabinet)]">
      <p className="font-pixel text-[9px] tracking-[2px] text-cross uppercase">
        ▸ Game over
      </p>
      <h1 className="mt-3 font-pixel text-[13px] leading-[1.5] text-ink">
        RAPID FIRE
      </h1>
