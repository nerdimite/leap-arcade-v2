...
const CONFETTI = [
  { dx: "-46px", dy: "-30px", rot: "-160deg", color: "var(--four)", delay: "0ms" },
  { dx: "-26px", dy: "-44px", rot: "120deg", color: "var(--rapid)", delay: "20ms" },
  { dx: "-8px", dy: "-50px", rot: "-90deg", color: "var(--wiki)", delay: "0ms" },
  { dx: "12px", dy: "-48px", rot: "200deg", color: "var(--pin)", delay: "40ms" },
  { dx: "30px", dy: "-40px", rot: "-140deg", color: "var(--four)", delay: "10ms" },
  { dx: "48px", dy: "-26px", rot: "90deg", color: "var(--rapid)", delay: "30ms" },
  { dx: "-38px", dy: "-12px", rot: "160deg", color: "var(--wiki)", delay: "50ms" },
  { dx: "40px", dy: "-10px", rot: "-110deg", color: "var(--four)", delay: "60ms" },
];
...
export function FeedbackBand(props: { lastCorrect: boolean; scoreDelta: number }) {
  ...
  return (
    ...
    >
      ...
      {correct && props.scoreDelta > 0 ? (
        <span className="pointer-events-none absolute right-6 top-1/2 motion-reduce:hidden">
          {CONFETTI.map((p) => (
            <span
              key={`${p.dx}-${p.dy}-${p.rot}`}
