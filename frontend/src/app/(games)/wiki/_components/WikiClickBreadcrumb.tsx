...
export function WikiClickBreadcrumb(props: WikiClickBreadcrumbProps) {
  ...
  return (
    ...
    >
      <span className="shrink-0 text-[9px] tracking-[1px] uppercase">Path</span>
      <div className="max-w-full [scrollbar-width:thin] overflow-x-auto overscroll-x-contain [-ms-overflow-style:none] [&::-webkit-scrollbar]:h-1">
