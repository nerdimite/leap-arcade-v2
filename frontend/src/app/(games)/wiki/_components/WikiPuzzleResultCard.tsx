  ...
  return (
    <div className="mx-auto flex max-w-lg flex-col gap-4 p-6">
      <div className="overflow-hidden rounded-[var(--radius)] border-2 border-line bg-panel shadow-[var(--shadow-cabinet)]">
        ...
        />
        <div className="p-6">
          <h1 className="font-pixel text-[9px] tracking-[2px] text-[var(--accent,var(--wiki))] uppercase">
            <span aria-hidden>▸ </span>Puzzle complete
          </h1>
          <p className="mt-4 text-[11px] font-bold tracking-[1px] text-ink-faint uppercase">
            Target revealed
          </p>
