...
from leap.api.routes.games import four_pics, picture, pinpoint, rapid_fire, wiki, word_hunt
...
app.include_router(word_hunt.router, prefix="/games/word-hunt", tags=["Word Hunt"])
